...
|-------|--------------------|--------------------|
| Phase 1: EAP (Closed Beta) | Goal: validate core UX, value, workflow. 5–10 customers max. $0 order form. | Free (AI Credits). High-touch PO/Eng engagement. |
...
to the risk, complexity, and impact of the feature. Phase 2 is optional — PO decides based
...
| Identify proto-champions | Pilot PO shortlist |
...
| Day 90+ | Data-backed mandate discussion — only after PO satisfaction confirmed |
